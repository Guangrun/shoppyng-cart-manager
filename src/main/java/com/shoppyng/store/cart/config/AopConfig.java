...
public class AopConfig {
	...
	@Pointcut("execution(public * com.shoppyng.store.cart..serviceapi.*.*(..))")
	public void service() {
	}
	...
	public Advisor serviceContextStoreAdvisor() {
		...
		pointcut.setExpression("com.shoppyng.store.cart.config.AopConfig.service()");
	...
	public Advisor jpaFlushEagerAdvisor() {
		AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut();
		pointcut.setExpression("com.shoppyng.store.cart.config.AopConfig.service() && !com.shoppyng.store.cart.config.AopConfig.readOnlyMethod()");
